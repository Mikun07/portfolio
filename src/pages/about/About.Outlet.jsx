...
function AboutOutlet() {
    return (
        <div name="about" className='bg-[#F5FBFF] w-full h-full text-gray-900 md:mt-10 sm:mt-48'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-gray-500'>About</p>
                </div>
                <p className='text-xl mt-4'>
                    Hi, my name is Festus-Olaleye Ayomikun. A skilled front-end developer who has made significant contributions to web development. With 4 years of experience, I have become proficient in using HTML, CSS, and JavaScript to create visually appealing and user-friendly interfaces for websites and applications.
                </p>
